...
const UserProfileScreen: React.FC = () => {
  ...
  const profileLock = useGuestLock({ 
    feature: 'profile customization', 
    title: 'Customize Your Profile!',
    message: 'Sign in to upload a profile picture and personalize your profile.'
  });
  const preferencesLock = useGuestLock({ 
    feature: 'setting style preferences', 
    title: 'Personalize Your Style!',
    message: 'Sign in to set your style preferences and get personalized recommendations.'
  });
  ...
  const handleProfilePictureSelection = useCallback(() => {
    const actionAllowed = profileLock.lockAction(() => {
      Alert.alert(
          ...
          <View style={[styles.preferencesPreview, { backgroundColor: cardBgColor }]}>
            <View style={styles.preferencesHeader}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => {
                  const actionAllowed = profileLock.lockAction(() => {
                    navigation.navigate('UserPreferencesScreen' as never);
                  });
                  if (!actionAllowed) return;
                }}
              >
            ...
            {preferences ? (
              ...
              <View style={styles.noPreferencesContainer}>
                ...
                <TouchableOpacity 
                  ...
                  onPress={() => {
                    const actionAllowed = preferencesLock.lockAction(() => {
                      navigation.navigate('UserPreferencesScreen' as never);
                    });
                    if (!actionAllowed) return;
                  }}
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: bgColor }]}>
      ...
      <LockOverlay
        {...profileLock.lockProps}
      />
      <LockOverlay
        {...preferencesLock.lockProps}
      />
